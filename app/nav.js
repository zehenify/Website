  ...
  return (
    <>
      ...
      <Box sx={{
        ...
        <Box sx={{ display: 'flex', flexDirection: 'row', ml: '60px' }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <Box onClick={handleClick} sx={{ display: 'flex', flexDirection: 'row', cursor: 'pointer' }} >

              <Image src={isClicked ? arrowRight : arrowUp} alt="Image" width={70} height={50} />

              <Typography
                sx={{
                  color: isClicked ? '#006466' : '#22222299',
                  fontWeight: isClicked ? 'bold' : 'none',
                  fontSize: '35px'
                }}>
                Psychiatrists
              </Typography>
            ...
            <Box onClick={handleClick} sx={{ display: 'flex', flexDirection: 'row', mt: '20px', cursor: 'pointer' }} >
